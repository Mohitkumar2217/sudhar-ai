...
ACTIVE_STATUSES = ("PENDING", "SCHEDULED_RETRY", "DUNNING_ACTIVE", "FRAUD_REVIEW")
PIPELINE_STAGES = ("PENDING", "SCHEDULED_RETRY", "DUNNING_ACTIVE", "FRAUD_REVIEW", "RECOVERED", "FAILED_EXHAUSTED")
